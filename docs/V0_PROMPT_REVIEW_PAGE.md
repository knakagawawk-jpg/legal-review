# v0用プロンプト：講評結果ページのデザイン改善

## 概要

法律答案の自動講評システムの講評結果ページをv0でデザイン改善します。
現在のページはStreamlitで実装されており、左右2カラムレイアウトで講評結果を表示しています。
...
1. **ダッシュボードUI**: 情報の階層化とビジュアライゼーション
...
- Streamlitの制約（カスタムCSS/JSの注入）を考慮してデザインを提案してください
- 既存の機能（スライダー、タブ、チャット）は維持してください
