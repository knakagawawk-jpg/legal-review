...
export function DatePickerCalendar({ selectedDate, onSelect, className }: DatePickerCalendarProps) {
        ...
        {days.map((day, index) => (
          <button
            ...
            className={cn(
              ...
              day === null && "text-transparent cursor-default",
              day !== null && "cursor-pointer hover:bg-muted",
              day !== null && isToday(day) && "bg-amber-500 text-white font-semibold",
              day !== null && isSelected(day) && !isToday(day) && "bg-amber-100 text-amber-900 font-semibold"
            )}
          >
            {day}
          </button>
