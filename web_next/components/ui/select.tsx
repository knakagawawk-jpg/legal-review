  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[size=default]:h-9 data-[size=default]:px-3 data-[size=default]:py-2 data-[size=default]:text-sm [&_svg]:data-[size=default]:size-4",
        "data-[size=sm]:h-8 data-[size=sm]:px-3 data-[size=sm]:py-2 data-[size=sm]:text-sm [&_svg]:data-[size=sm]:size-4",
        "data-[size=xs]:h-7 data-[size=xs]:min-h-7 data-[size=xs]:px-2 data-[size=xs]:py-1 data-[size=xs]:text-xs data-[size=xs]:[&_svg]:!size-3.5",
        className,
      )}
      {...props}
    >
