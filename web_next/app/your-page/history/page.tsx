...
import { StudyManagementPage } from "../data/study-management-page"

/**
 * Your Data ページ（MEMO + Topics のみ）
 * /your-page/history: 目標・Targetタブを省略したシンプル表示
 */
function DataPageMemoTopics() {
  ...
  return (
    ...
    >
      ...
      <main className="container mx-auto px-4 sm:px-8 lg:px-12 py-4 max-w-7xl">
        <StudyManagementPage variant="memo-topics-only" />
      </main>
    </div>
  )
}

export default withAuth(DataPageMemoTopics, { requireAuth: true })
