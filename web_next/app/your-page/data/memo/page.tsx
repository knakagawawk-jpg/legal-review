...
import { Lightbulb, ArrowLeft, Plus, Calendar as CalendarIcon } from "lucide-react"
...
import { SUBJECT_COLORS, POINT_STATUS_OPTIONS } from "@/lib/dashboard-constants"
...
const MEMO_HEADERS = [
  ...
  { id: "status", label: "種類", width: "5rem", minWidth: "5rem" },
  { id: "memo", label: "メモ", minWidth: "399px" },
  { id: "fav", label: "♡", width: "3rem", className: "text-center" },
  { id: "created", label: "作成日", width: "5rem", minWidth: "5rem" },
]
...
function MemoPage() {
  ...
  const convertToTopic = useCallback(async (itemId: number) => {
    try {
        ...
        <>
          ...
          <TableCell className="py-2 px-2 w-20 align-top">
            ...
            >
              ...
              <SelectContent>
                {POINT_STATUS_OPTIONS.filter((o) => o.value != null).map((o) => (
        ...
        <Card className="shadow-sm border-amber-200/60">
          <CardContent className="p-4">
            <MainTableItems
              ...
              statusOptionsForFilter={[...POINT_STATUS_OPTIONS]}
              statusFilterAllLabel="全種類"
              headerColumns={MEMO_HEADERS}
              renderRow={renderRow}
